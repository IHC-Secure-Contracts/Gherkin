...
And le muestra los detalles de cada <notificación> en tarjetas que contienen “Título de contrato”, “Documento de contrato” y  un icono que representa el estado(aceptado o rechazado) del documento.
