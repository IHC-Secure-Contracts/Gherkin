...
Cuando el usuario ingrese su <correo> y <contraseña> 
...
Y muestra cada contrato en la ventana de inicio incluyendo el título del contrato, el nombre de la persona con la que se está haciendo el contrato y una imagen referencial. 
Y permite que el usuario pueda hacer clic en un contrato listado en la ventana de inicio para ver sus detalles.


Examples: Tarjetas
    |         titulo         | |    nombre persona    | |     imagen     |
